    ...
    return (
        <div className="my-10 flex flex-col-reverse items-center lg:flex-row">
            <form onSubmit={handleSubmit(onSubmit)} className="lg:w-2/3 mx-8 bg-violet-50 p-10 md:p-16 rounded-3xl border border-violet-200">
                ...
                <button type="submit" className="text-white mb-1 bg-orange-700 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
