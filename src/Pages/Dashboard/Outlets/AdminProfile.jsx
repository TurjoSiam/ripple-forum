        ...
        <div className="col-span-9 my-10">
            ...
            <div className="w-11/12 md:w-10/12 mx-auto">
                <form onSubmit={handleSubmit(onSubmit)} className="mx-8 bg-orange-50 p-10 md:p-16 rounded-3xl border border-cyan-200">
                    ...
                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Tag</button>
                </form>
            </div>
        </div>
    );
