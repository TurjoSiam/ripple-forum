...
const Announcement = () => {
    ...
    return (
        <div className="my-10 col-span-9 w-11/12 md:w-5/6 mx-auto">
            <form onSubmit={handleSubmit(onSubmit)} className="bg-orange-50 p-10 md:p-16 rounded-3xl border border-cyan-200">
                ...
                <button type="submit" className="text-white bg-orange-500 hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Announcement</button>
            </form>
        </div>
    );
