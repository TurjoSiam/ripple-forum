        ...
        <div className="w-8/12 mx-auto my-10">
            <form onSubmit={handleSubmit(onSubmit)} className="mx-8 bg-orange-50 p-10 md:p-16 rounded-3xl border border-cyan-200">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" {...register('name')} required className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="url" {...register('photo')} required className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
