    ...
    return (
        <div className="my-10 flex items-center flex-col-reverse lg:flex-row">
            <form onSubmit={handleSubmit(onSubmit)} className="lg:w-2/3 mx-8 bg-cyan-50 p-10 md:p-16 rounded-3xl border border-cyan-200">
                ...
                <button type="submit" className="text-white bg-orange-700 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                <button onClick={handleGoogleSignin} className="btn w-full md:w-auto md:ml-2 mt-1 md:mt-0 bg-red-200 hover:bg-red-100"><FcGoogle /> Sign In with Google</button>
