...
const Posts = () => {
    ...
    return (
        <div className="relative">
            {/* search bar */}
            <form onSubmit={handleSubmit} className="flex items-center gap-1 absolute -top-16 md:-top-20 left-4 md:left-24 border-2 border-orange-400 rounded-xl">
            ...
            {/* cards of posts */}
            <div className="flex items-center justify-end gap-1 w-11/12 md:w-6/12 mx-auto my-2">
