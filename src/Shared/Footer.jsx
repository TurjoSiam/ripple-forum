...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-tr from-[#125B99] to-[#352A7D]">
        <div className="mx-auto w-full max-w-screen-xl px-4 py-5">
            <div className="lg:flex lg:justify-between">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-6 md:grid-cols-3">
                    <div>
                        <h2 className="mb-3 text-sm font-semibold text-white uppercase ">Resources</h2>
                    ...
                    <div>
                        <h2 className="mb-3 text-sm font-semibold text-white uppercase ">Legal</h2>
                    ...
                    <div className='w-64'>
                        <h2 className="mb-3 text-sm font-semibold text-white uppercase ">Description</h2>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://discord.com/channels/1323883740744646758/1323883740744646761" className="text-gray-200 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <a href="https://x.com/SiamTurjo" className="text-gray-200 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <a href="https://github.com/TurjoSiam" className="text-gray-200 hover:text-gray-900 dark:hover:text-white ms-5">
